...
public class HeaderHelperTest
{
    ...
    [Fact]
    public void GenerateHeaderTest_Case2()
    {
        var header = HeaderHelper.GenerateHeader(OperationType.Read, "V4000", nbAddressRead: 10, slaveAddress: 1, masterAddress: 0);
